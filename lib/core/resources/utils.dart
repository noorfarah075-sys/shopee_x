...
class Utils{
  ...
  static const String titleOnbourding1 = " 🛍️Discover Amazing Products";
  static const String titleOnbourding2 = "🔍Smart Search & Filters";
  static const String titleOnbourding3 = "🔒Safe & Easy Checkout";
  static const String titleOnbourding4 = "🚚Fast Delivery to Your Door ";
  static const String titleOnbourding5 = "⭐Save Your Favorites";
  static const String titleOnbourding6 = " 🚀 Ready to Start Shopping?";
  static const String descriptionOnbourding1 =
      "Browse thousands of products from top brands.Find exactly what you need at unbeatable prices, all  in one place.";
  static const String descriptionOnbourding2 =
      "Find what you love instantly. Filter by category, price, brand, and rating to get perfectly tailored  results.";
  static const String descriptionOnbourding3 =
      "Multiple payment options with bank-level security.  Shop with complete confidence every single time.";
  static const String descriptionOnbourding4 =
      "Get your orders delivered in record time. Track every  step in real-time, from warehouse to doorstep.";
  static const String descriptionOnbourding5 =
      "Add products to your wishlist and never lose track  of what you love. Get notified instantly when prices  drop.";
  static const String descriptionOnbourding6 =
      "Join millions of happy shoppers today. Create your  free account and unlock exclusive deals instantly.";
  static const String next = "Next";
  static const String signUp = "Sign Up";

  static const String skip = "Skip";

  static const String appTaglineLine1 = "Beautiful eCommerce UI Kit for your online";
  static const String appTaglineLine2 = "store";
